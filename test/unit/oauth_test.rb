...
class Docusigner::OauthTest < Test::Unit::TestCase
  ...
  should "be able to fetch an OAuth token with username/password/integrator key" do
    stub_request(:post, "https://demo.docusign.net/restapi/v2/oauth2/token")
    ...
    assert_requested(:post, "https://demo.docusign.net/restapi/v2/oauth2/token")
    assert_equal("myoauthtoken", token)
  end

  should "be able to revoke an OAuth token" do
    stub_request(:post, "https://demo.docusign.net/restapi/v2/oauth2/revoke")
      .with(:headers => {"Authorization" => "Bearer mytoken"})
      .to_return(:body => "")
    Docusigner::Oauth2.revoke("mytoken")
    assert_requested(:post, "https://demo.docusign.net/restapi/v2/oauth2/revoke")
  end
